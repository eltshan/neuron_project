...
public class TestGraphs {
   ...
   * 
   */
  public static String[][] pairs = { { "a", "b", "3" }, { "a", "c", "4" }, { "a", "d", "5" },
      { "d", "c", "6" }, { "d", "e", "7" }, { "e", "f", "8" }, { "f", "g", "9" }, { "h", "i", "1" } };

  /**
   * Creates a small sample graph that can be used for testing purposes. The graph is as described
   * in the section on {@link #pairs pairs}. If <code>isDirected</code>, the graph is a
   * {@link DirectedSparseMultigraph DirectedSparseMultigraph}, otherwise, it is an
  ...
  /**
   * Returns a graph consisting of a chain of <code>vertex_count - 1</code> vertices plus one
   * isolated vertex.
   */
   ...
   * (randomly) to nodes in earlier (but never later) layers. Each layer has some random number of
   * nodes in it 1 less than n less than maxNodesPerLayer.
   * 
   * @return the created graph
   */
  public static Graph<String, Number> createDirectedAcyclicGraph(int layers, int maxNodesPerLayer,
          double linkprob) {
